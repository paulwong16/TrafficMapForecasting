...
config['static_map'] = './data_new_raw/BERLIN/BERLIN_static_2019.h5'
...
config['model']['static_in'] = 7
config['model']['static_out'] = 1

config['cont_model_path'] = None  # Use this to continue training a previously started model.
# config['cont_model_path'] = './runs/Unet-2020-07-24-14-35-41-BERLIN'
